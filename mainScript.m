...
%% Fig 4D (FA GI: HCP) 
fnameRoot = "GI_Distribution_FA_HCP_TRT";
...
%% Fig 6A (GI Correlation FA: b1000) 
fnameRoot = "GI_Correlation_FA_b1000";
includeExp =  {'HCP1000TEST','HCP1000RETEST'};
GIplot(unsMeansALL, includeExp, 'useDistribution',false, 'ResultType','Correlation', ...
       'winSizeInch',[0,0,20,5], 'nrowcol',[1,6], 'ylab', 'L-R Correlation', ...
